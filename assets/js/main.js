...
// const order=array.find(item=>item.id===id);
// console.log(order.shipAddress.country);}

//task2
// function findobject(x) {
// const order=array.find(item=>item.shipAddress.country===x);
// console.log(order);
// }

//task3
//function finder(id) {
//let order=array.find(item=>item.id===id);
//console.log(order.shipName);
//console.log(order.shipAddress.city);   
//}
//task4
...
//task5
// function totalfind(id) {
// const order = array.find(item => item.id === id);
// let totalDiscount = 0;
// for (const detail of order.details) {
// totalDiscount += detail.unitPrice * detail.quantity * (1 - detail.discount);
// }
